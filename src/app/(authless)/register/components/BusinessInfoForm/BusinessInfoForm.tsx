  ...
  return (
    <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
      <div style={{ marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <Tooltip title="Daxil edilən məlumatlar yalnız yoxlama məqsədilə istifadə olunacaq və üçüncü şəxslərlə paylaşılmayacaq.">
      ...
      >
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <Radio.Group {...field} className={'text-right!'}>
        ...
        <>
          ...
          >
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Select placeholder="Şəhəri seçin" {...field}>
          ...
          >
            <Controller
              name="description"
              control={control}
              render={({ field }) => <Input.TextArea rows={3} maxLength={1000} {...field} />}
            />
          </Form.Item>
          ...
          <Form.Item
            ...
            required
            validateStatus={errors.motivationLetter ? 'error' : ''}
            help={errors.motivationLetter?.message}
          >
            <Controller
        ...
        <>
          ...
          >
            <Controller
              ...
              render={({ field }) => (
                <Input placeholder="Biznes adını daxil edin" {...field} maxLength={255} />
              )}
            />
          </Form.Item>
          ...
          >
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Input placeholder="Ünvanınızı daxil edin" {...field} maxLength={255} />
              )}
            />
          </Form.Item>
          ...
          >
            <Controller
              ...
              render={({ field }) => <Input placeholder="+994 XX XXX XX XX" {...field} />}
            />
          </Form.Item>

          <Form.Item
            label="Biznes Haqqında Qısa Məlumat"
            required
            validateStatus={errors.description ? 'error' : ''}
            help={errors.description?.message}
          >
            ...
            <Controller
              ...
              render={({ field }) => (
                <FileUploader
                  ...
                  accept="image/*"
                  defaultFiles={mapperFileUploader(
                    businessInfo?.profileImage ? [businessInfo?.profileImage] : []
                  )}
                />
              )}
            />
