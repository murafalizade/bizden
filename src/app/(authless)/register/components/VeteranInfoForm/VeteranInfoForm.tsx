...
export const VeteranInfoForm: React.FC<VeteranInfoFormProps> = () => {
  ...
  return (
      <Form layout="vertical" style={{ marginTop: 20 }} onFinish={handleSubmit(onSubmit)}>
        ...
        <Form.Item label="Status" required validateStatus={errors.type ? 'error' : ''} help={errors.type?.message}>
          <Controller
              control={control}
              name="type"
        ...
        <Form.Item label="Əlaqədar Sahə" required validateStatus={errors.relevanceType ? 'error' : ''} help={errors.relevanceType?.message}>
          <Controller
              control={control}
              name="relevanceType"
              render={({ field, fieldState }) => (
        ...
        <Form.Item label="Təsvir" required validateStatus={errors.description ? 'error' : ''} help={errors.description?.message}>
          <Controller
              control={control}
              name="description"
              render={({ field, fieldState }) => (
        ...
        <Form.Item label="Təsdiqləyici Sənəd" required validateStatus={errors.veteranProofFiles ? 'error' : ''} help={errors.veteranProofFiles?.message}>
          <Controller
              control={control}
